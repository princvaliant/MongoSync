...
namespace kaiam.MongoSync.Sync
{
    ...
    class PowerCheckAssembly : SyncBase
    {
        private readonly string[] excludeDataFields = new string[] { "_entityWrapper", "Id", "TimeStamp", "PowerCheckAssemblySpec", "PowerCheckAssemblySpecId", "Measurement", "MeasurementId","Result" };
        ...
        private BsonDocument buildPowerCal(KAIAM.DataAccess.PowerCheckAssembly tcd)
        {
            ...
            BsonDocument nestedDevice = null;
                ...
                {
                    Program.log("ERROR POWER CHECK ASSEMBLY: " + tcd.Id + " - " + exc.Message);
                }
                finally
                {
